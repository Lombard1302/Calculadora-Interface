...
public class Teclado extends JPanel implements ActionListener {
	...
	private final Color COR_CINZA_ESCURO = new Color(85, 85, 85);
	private final Color COR_CINZA_CLARO = new Color(150, 150, 150);
	private final Color COR_LARANJA = new Color(255, 137, 0);
